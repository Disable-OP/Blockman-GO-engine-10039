...
namespace LORD
{
	...
	public:
		...
		*/
		virtual void playBackgroundMusic(String strFilePath, bool bLoop, float fMinInterval, float fMaxInterval);
		...
		*/
		virtual unsigned int playEffect(String strFilePath, bool bLoop, float fMinInterval, float fMaxInterval);
