...
namespace BLOCKMAN
{
	...
	{
	public:
		i32 uniqueId; // this is used to check if the Commodity in the client side and server side is the same
		i32 index;
		i32 itemId;
		i32 itemMeta;
		i32 itemNum;
		...
		DEFINE_NETWORK_SERIALIZER(uniqueId, index, itemId, itemMeta, itemNum, coinId, price, desc, image, notify, tipDesc);
	};
