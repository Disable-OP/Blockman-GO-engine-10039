        ...
        : m_levelName(levelName)
{
        ...
        m_timeStopped = false;
        m_totalTime = 0;
        // FIX: start worlds at NOON instead of dawn (time 0 = sunrise). Fresh
        // spawns were dim/orange-lit and VLM-scored nearly black in CI screenshots;
        // noon (6000) gives full sky brightness for the first ~5 minutes of play.
        // The day/night cycle still advances normally from here.
        m_worldTime = 6000;
        m_lastTimePlayed = 0;
        m_sizeOnDisk = 0;
        m_dimension = 0;
