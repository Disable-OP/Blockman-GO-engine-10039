#pragma once
#ifndef __GUI_RANCH_BUILD_FACTORY_HEADER__
#define __GUI_RANCH_BUILD_FACTORY_HEADER__
...
namespace BLOCKMAN
{
	class gui_ranchBuildFactory : public  gui_layout
	{
	private:
		enum class ViewId {
			MAIN,
	...
	private:
		...
		ProductQueue m_workingQueue;

	public:
		gui_ranchBuildFactory();
		virtual ~gui_ranchBuildFactory();
	...
	private:
		...
		GUIStaticText* m_tvPriceValue = nullptr;
